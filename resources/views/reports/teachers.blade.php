<x-layout title="تقارير المعلمين">
    <h1 class="page-title mb-1">تقارير المعلمين</h1>
    ...
    @else
        ...
        <p class="text-sm text-ink-400 mb-4">المعلم المشترك في أكثر من صف يظهر بسطر منفصل لكل صف يُدرّس فيه.</p>
        ...
        <div class="table-wrap">
            <table class="table-base">
                ...
                <tbody>
                    @forelse ($rows as $row)
                        <tr>
                            <td class="font-medium text-ink-900 dark:text-white">{{ $row['teacher']->name }}</td>
